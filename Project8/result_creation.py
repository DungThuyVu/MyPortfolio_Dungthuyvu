...
allowed_adapters = {"A0.1", "A0.2", "A0.3"}
allowed_cutoffs = {"CO5", "CO10", "CO33"}
...
fig, axes = plt.subplots(nrows=nrows, ncols=ncols, figsize=(11.0, 3.5 * nrows))

# Add global information as a second title line
prompt_info = (
    "Prompt: A cinematic tropical beach banner viewpoint towards the ocean crystal clear,\n"
    "turquoise water, soft golden sand, gentle waves, palm trees swaying in the breeze, \n"
    "warm sunlight. Include a orange logo in the bottom-right corner."
)
...
plt.savefig("final_results_collages/beach_rabb_grid_collage.png", dpi=300, bbox_inches="tight")
plt.show()